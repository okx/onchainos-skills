...
This handles CLI upgrade and workflows download. Tell the user the onchainos version and confirm workflows are up to date. If it fails, note it briefly and continue — never block the session.
