...
grep -qx 'unset OKX_BASE_URL' "$fixture_root/.codex/bin/onchainos"
grep -qx 'unset OKX_BASE_URL' "$fixture_root/.codex/bin/okx-a2a"
...
[[ "$(cd "$workspace_dir" && ./.codex/bin/onchainos probe)" == "tmp=$fixture_root/.codex/runtime/tmp base_url=unset version_gate=true local-onchainos probe" ]]
...
OKX_BASE_URL=https://beta.okex.org PATH="$fake_bin:$PATH" bash "$fixture_root/scripts/onchainos-local-dev-setup.sh" init >/dev/null
[[ "$(< "$fixture_root/.codex/build/cargo-target/observed-base-url")" == "https://beta.okex.org" ]]
[[ "$("$fixture_root/.codex/bin/onchainos" probe)" == "tmp=$fixture_root/.codex/runtime/tmp base_url=https://beta.okex.org version_gate=true local-onchainos probe" ]]
grep -qx 'export OKX_BASE_URL=https://beta.okex.org' "$fixture_root/.codex/bin/onchainos"
grep -qx 'export OKX_BASE_URL=https://beta.okex.org' "$fixture_root/.codex/bin/okx-a2a"
