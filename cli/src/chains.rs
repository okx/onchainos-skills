...
mod tests {
    ...
    fn resolve_chains_multiple() {
        assert_eq!(resolve_chains("ethereum,solana"), "1,501");
        assert_eq!(resolve_chains("eth,bsc,base"), "1,56,8453");
    }

    #[test]
    fn resolve_chains_trims_whitespace() {
        assert_eq!(resolve_chains("ethereum, solana"), "1,501");
        assert_eq!(resolve_chains(" eth , bsc "), "1,56");
    }
    ...
    fn evm_chain_id_non_evm_returns_none() {
        ...
        assert_eq!(evm_chain_id("unknown"), None);
    }
    ...
    #[test]
    fn chain_family_evm_and_fallthrough() {
        assert_eq!(chain_family("1"), "evm");
        assert_eq!(chain_family("56"), "evm");
        assert_eq!(chain_family("8453"), "evm");
        assert_eq!(chain_family("784"), "evm"); // Sui falls through to evm
    ...
    #[test]
    fn native_token_address_non_evm() {
        assert_eq!(
    ...
    fn native_token_address_evm_chains() {
        let evm = "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee";
        assert_eq!(native_token_address("1"), evm);
        assert_eq!(native_token_address("56"), evm);
        assert_eq!(native_token_address("137"), evm);
        assert_eq!(native_token_address("8453"), evm);
        assert_eq!(native_token_address("unknown"), evm);
    }
}
