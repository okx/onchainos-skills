...
fn agent_sub(cmd: &crate::commands::agent_commerce::AgentCommand) -> String {
    ...
    match cmd {
        ...
        AgentCommand::AckToConfirm { .. } => "ack-to-confirm".into(),
        AgentCommand::GetAgreed { .. } => "get-agreed".into(),
        ...
        AgentCommand::SaveAgreedAndSetPayment { .. } => "save-agreed-and-set-payment".into(),
