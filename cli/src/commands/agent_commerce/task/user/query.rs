...
use crate::commands::agent_commerce::task::common::{
    query as common_query, AGENT_ROLE_USER, XLAYER_CHAIN_ID,
};

/// Generate the payment invoice (sent by the asp to the user after `provider_applied`).
pub async fn handle_payment(
    ...
    let payment_mode = crate::commands::agent_commerce::task::common::PaymentMode::from_int(
        payment_mode_int as i32,
    );
