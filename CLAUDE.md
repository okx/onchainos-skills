...
| okx-hackathon | Register a Trading ASP agent for the OKX.AI trading hackathon (交易黑客松) | User wants to sign up / 报名 their Trading ASP agent for the OKX.AI hackathon, or mentions "黑客松" / "hackathon" together with an agent/ASP |
