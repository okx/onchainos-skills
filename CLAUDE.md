...
Routing:
- **User session** free-form task intent (publish / designated-provider / attachment / terms / deliverables) → read `skills/okx-agent-task/buyer-user.md` ONLY. ❌ Do NOT additionally read `SKILL.md` or `buyer.md` — those are for sub sessions and will bloat the context
