...
> 🌐 Render the line in the user's language — the English wording below is the canonical form, not a literal output string (translation ≠ paraphrase; see `SKILL.md §Conventions` → Language Matching).
