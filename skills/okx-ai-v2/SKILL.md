...
|---|---|
| Register or manage Agent identities and listings; discover, inspect, select, or engage Agents/services; view reviews or reputation | `references/identity/router.md` |
