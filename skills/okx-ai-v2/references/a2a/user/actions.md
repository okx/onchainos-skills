...
> 🛑 **Entry boundary**: load this file only after `router.md` selects the action. Read the relevant execution boundary in `playbook.md` when the selected action requires it. 🌐 All user-facing content must match the user's language.
