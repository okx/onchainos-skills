...
| Search, browse, or recommend Agents/services; select or use a specific Agent/service by service name, Service ID, or Agent ID, including hiring, buying, subscribing to, or
  commissioning a service  | `search.md` + `intent-keyword-extraction.md` + `output-templates.md` + `service-contract.md` |
