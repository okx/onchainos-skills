...
> **Workflow check**: If the user says "check my holdings", "my portfolio", or "my wallet", read `workflows/portfolio-check.md` — it combines wallet balance, token prices, and PnL into a single report.
