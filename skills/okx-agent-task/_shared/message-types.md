...
Sent via `xmtp_dispatch_session` when the user adds an attachment to a task mid-flow. The sub session receives it and processes per `buyer-sub-playbook.md` §3.5 routing rule #5.
