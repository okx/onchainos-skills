...
Each agent turn is stateless, with **no built-in loop protection**. The 4 rules below cover all a2a / CLI scenarios. `buyer-sub-playbook.md` / `asp.md` stack role-specific exceptions on top (each writing their own §6).
