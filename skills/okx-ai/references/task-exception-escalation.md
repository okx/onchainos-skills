...
An insufficient-balance intent is not a generic CLI-failure escalation. Ask
whether the user wants to fund; if the user chooses funding, read
[funding.md](../../_shared/funding.md).
