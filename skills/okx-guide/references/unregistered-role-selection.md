...
> When the reply names the Evaluator role with a legacy word (仲裁者 / 仲裁员 / 评估者 / arbiter / Arbitrator), apply the [role-confirmation mapping rules](../../okx-ai/references/identity/register.md#1-role-confirmation) before routing.
