...
|---|---|---|
| `1` (User) | `Registering your User identity, hang tight... ⏳` | [`../../okx-ai/references/identity-register.md`](../../okx-ai/references/identity-register.md) (role `User`) |
| `2` (ASP) | `Registering your ASP identity, hang tight... ⏳` | [`../../okx-ai/references/identity-register.md`](../../okx-ai/references/identity-register.md) (role `ASP`) |
| `3` (Evaluator) | `Registering your Evaluator identity, hang tight... ⏳` | [`../../okx-ai/references/identity-register.md`](../../okx-ai/references/identity-register.md) (role `Evaluator`) |
...
> When the reply names the Evaluator role with a legacy word (仲裁者 / 仲裁员 / 评估者 / arbiter / Arbitrator), apply §Evaluator legacy aliases in [`../../okx-ai/references/identity-register.md`](../../okx-ai/references/identity-register.md) before routing.
