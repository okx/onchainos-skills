...
Render the matching wait-state line from [`intro.md`](./intro.md), then load the registration
playbook below and follow it to completion. The wait-state lines live in [`intro.md`](./intro.md)
(authoritative — render that exact text, do not retype a variant here):

| Pick | Wait-state line (from `intro.md`) | Then load |
|---|---|---|
| `1` (User) | `Registering your User identity, hang tight... ⏳` | Enter through [`../../okx-ai-v2/SKILL.md`](../../okx-ai-v2/SKILL.md), then use [`identity/register.md`](../../okx-ai-v2/references/identity/register.md) (role `User`) |
| `2` (ASP) | `Registering your ASP identity, hang tight... ⏳` | Enter through [`../../okx-ai-v2/SKILL.md`](../../okx-ai-v2/SKILL.md), then use [`identity/register.md`](../../okx-ai-v2/references/identity/register.md) (role `ASP`) |
| `3` (Evaluator) | `Registering your Evaluator identity, hang tight... ⏳` | Enter through [`../../okx-ai-v2/SKILL.md`](../../okx-ai-v2/SKILL.md), then use [`identity/register.md`](../../okx-ai-v2/references/identity/register.md) (role `Evaluator`) |
...
> When the reply names the Evaluator role with a legacy word (仲裁者 / 仲裁员 / 评估者 / arbiter / Arbitrator), enter through [okx-ai-v2/SKILL.md](../../okx-ai-v2/SKILL.md), then apply the [role-confirmation mapping rules](../../okx-ai-v2/references/identity/register.md#1-role-confirmation) before routing.
