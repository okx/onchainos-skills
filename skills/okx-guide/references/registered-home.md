...
> When a register-a-role request names the Evaluator role with a legacy word (仲裁者 / 仲裁员 / 评估者 / arbiter / Arbitrator), apply §Evaluator legacy aliases in [`../../okx-ai/references/identity-register.md`](../../okx-ai/references/identity-register.md) before routing.
