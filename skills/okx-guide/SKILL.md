...
|---|---|
| First-time / "what is onchainos" / "what can it do" / how to use / how to play / getting started / tutorial / "I just installed" / "now what" / "where do I start" / "I'm new" / welcome banner + numbered-pick routing | [`references/how-to-play.md`](./references/how-to-play.md) (renders the banner from [`references/welcome.md`](./references/welcome.md)) |
| OKX.AI — "what is OKX.AI" / "how to use OKX.AI" / "OKX.AI 快速开始" (any spelling variant) / register a role (User / ASP / Evaluator) / platform detection / registered-user home | [`references/ai-guide.md`](./references/ai-guide.md) (copy templates in [`references/intro.md`](./references/intro.md); role pick → [`references/unregistered-role-selection.md`](./references/unregistered-role-selection.md); registered home → [`references/registered-home.md`](./references/registered-home.md)) |
