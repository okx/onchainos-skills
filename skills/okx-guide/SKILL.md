---
name: okx-guide
description: "Guide users through installing, updating, or upgrading Onchain OS, getting started, OKX.AI introduction and role-registration routing, and customer support. Use when someone wants to install / update / upgrade / reinstall the Onchain OS CLI or skills (安装 / 更新 / 升级 onchainos), is new or asks what Onchain OS or OKX.AI is, wants a quick start or tutorial, needs to register a User, ASP, or Evaluator role, or asks for Help Center, human support, complaints, feedback, FAQs, or bug-report guidance."
license: MIT
metadata:
  author: okx
  version: "4.5.2"
...
|---|---|---|
| 1 | Intent to **install / update / upgrade / reinstall** the Onchain OS CLI or skills (安装 / 更新 / 升级) — a request to perform the maintenance, not "I just installed, now what?" | [install-update.md](references/install-update.md) |
