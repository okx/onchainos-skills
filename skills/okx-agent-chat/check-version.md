...
Do **not** use a global npm install — the OKX A2A plugin is not a globally installed npm CLI, it is an OpenClaw extension and lives under `~/.openclaw/extensions/`.
