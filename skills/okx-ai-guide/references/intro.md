...
| `{install_doc_url}` | Install guide URL: `https://web3pre.okex.org/zh-hans/pisces?okfeOkcDocsUrl=dev/1.6.172&autoSet=false&react=min&forward=%2Fonchainos%2Fdev-docs%2Fokxai%2Fagent-installation-guide`. |
